...
namespace SelectData.Manager.Player {
    public class KartController : MonoBehaviour
    {
        ...
        public CinemachineVirtualCamera vcamera_front;
        public CinemachineVirtualCamera vcamera_back;
        ...
        public Transform tube001;
        public Transform tube002;
        ...
        public void Boost()
        {
            ...
            if (driftMode > 0)
            {
                ...
                tube001.GetComponentInChildren<ParticleSystem>().Play();
                tube002.GetComponentInChildren<ParticleSystem>().Play();
            }
        ...
        {
            //Tire
            //frontWheels     = GameObject.FindGameObjectWithTag("Tire").gameObject.transform.GetChild(0);
             frontWheels = kartModel.transform.Find("Tire_" + myGameManagerData.GetTireNumber() + "(Clone)/Front_Wheels");
            backWheels = kartModel.transform.Find("Tire_" + myGameManagerData.GetTireNumber() + "(Clone)/Back_Wheels");
            wheelParticles = kartModel.transform.Find("Tire_" + myGameManagerData.GetTireNumber() + "(Clone)/WheelParticles");
            flashParticles = kartModel.transform.Find("Tire_" + myGameManagerData.GetTireNumber() + "(Clone)/DashParticles");
            Debug.Log("TireNum::" + myGameManagerData.GetTireNumber());
            //Body
            steeringWheel = kartModel.transform.Find("Body_" + myGameManagerData.GetBodyNumber() + "(Clone)/Handle");
            tube001 = kartModel.transform.Find("Body_" + myGameManagerData.GetBodyNumber() + "(Clone)/Tube001");
            tube002 = kartModel.transform.Find("Body_" + myGameManagerData.GetBodyNumber() + "(Clone)/Tube002");
            Debug.Log("BodyNum::" + myGameManagerData.GetBodyNumber());
        }
